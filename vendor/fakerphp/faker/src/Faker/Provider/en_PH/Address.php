...
class Address extends \Faker\Provider\en_US\Address
{
    ...
    protected static $addressFormats = [
        '{{streetAddress}}, {{taskay}}, {{city}} {{postcode}} {{province}}', '{{streetAddress}}, {{municipality}} {{postcode}} {{province}}',
    ];
    ...
    public function taskay()
    {
        return static::randomElement(static::$taskay);
    }
}
