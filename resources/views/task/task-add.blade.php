      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <form class="needs-validation" novalidate action="/task" method="POST">
              @csrf
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Name Task" value="{{old('name')}}" required>
                      @error('name')
